...
$default_deep_link  = get_option('cUsDF_settings_default_deep_link_view');
$showHints          = get_option('cUsDF_settings_intro_hints'); //intro hints
...
$cUsDF_API_getFormKeys = $cUsDF_api->getFormKeysData($cUs_API_Account, $cUs_API_Key); //api hook;
update_option('cUsDF_settings_FORMS', $cUsDF_API_getFormKeys);

$default_deep_link = $cUsDF_api->parse_deeplink ( $default_deep_link );
if( !strlen($default_deep_link) ){
    $default_deep_link = $cUsDF_api->getDefaultDeepLink( $cUsDF_API_getFormKeys ); // get a default deeplink
    update_option('cUsDF_settings_default_deep_link_view', $default_deep_link );
}
...
$partnerID = $cUsDF_api->get_partner_id($default_deep_link);
$cus_CRED_url = cUsDF_PARTNER_URL . '/index.php?loginName='.$cUs_API_Account.'&userPsswd='.urlencode($cUs_API_Key);
define('cUsDF_CRED_URL', $cus_CRED_url);
//echo $chataui = cUsDF_PARTNER_URL . '/'.$partnerID . '/';
                ...
                <div id="menu">
                    <div id="menuWrapper">
                        <ul id="tabs" data-tabs="tabs">
                            ...
                            <li>
                                <a id="cu_nav_docs" href="http://help.contactus.com/hc/en-us/sections/200263276-Donation-Form-Plugin-by-ContactUs-com" role="button" class="btn contacts-color" target="_blank">
                                    <span class="icon-book white"></span><span class="hidden-sm hidden-xs"> Documentation</span>
                                </a>
                            </li>

                            <li>
                                <a id="cu_nav_contacts" href="<?php echo cUsDF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsDF_PARTNER_URL .'/'. $partnerID.'/en/contacts/showContacts/latestSubmissions/'); ?>" role="button" class="btn btn-yellow tooltips" target="_blank" title="Opens ContactUs.com admin panel in new window" data-placement="right">
            ...
            <div class="col-xs-4 col-md-2 col-lg-3 noPadding">
                ...
                <div class="btn-group pull-right" id="userMenu">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a class="logout" target="_blank"  href="<?php echo cUsDF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsDF_PARTNER_URL .'/'. $partnerID.'/en/account/accountSettings'); ?>"><span class="icon-cog"></span> Account Settings </a>
                        </li>
                        <li>
                            <a class="logout" target="_blank"  href="<?php echo cUsDF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsDF_PARTNER_URL .'/'. $partnerID.'/en/account/changePassword'); ?>"><span class="icon-lock"></span> Change Password </a>
                        </li>
                        <!-- li>
                        ...
                        <li>
                            <a class="logout" target="_blank"  href="<?php echo cUsDF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsDF_PARTNER_URL .'/'. $partnerID.'/en/plans'); ?>"><span class="icon-chart-bar"></span> Plans </a>
                        </li>
                        <li>
                            <a class="logout" target="_blank"  href="<?php echo cUsDF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsDF_PARTNER_URL .'/'. $partnerID.'/en/account/usage'); ?>"><span class="icon-chart-line"></span> Usage </a>
                        </li>
                        <li>
                            <a class="logout" target="_blank"  href="<?php echo cUsDF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsDF_PARTNER_URL .'/'. $partnerID.'/en/account/api'); ?>"><span class="icon-key"></span> API </a>
                        </li>
                        <li>
                            <a class="logout" target="_blank"  href="<?php echo cUsDF_CRED_URL; ?>&confirmed=1&redir_url=<?php echo urlencode(cUsDF_PARTNER_URL .'/'. $partnerID.'/en/account/returningLeadAlert'); ?>"><span class="icon-attention"></span> Returning Lead Alert </a>
                        </li>
                        <!-- li>
        ...
        <div id="tabs1" class="tab-pane active">
            <div class="row">
                <div class="col-sm-8">
                    ...
                    * @since 1.0
                    */
                    require_once( cUsDF_DIR . 'views/my-forms.php');
                    ?>
                </div>
                ...
                <div class="col-sm-4 sidebar">
                     ...
                     * @since 1.0
                     */
                    include( cUsDF_DIR . 'views/sidebar.php');
                    ?>
                </div>
            </div>
        </div>
        ...
        <div id="tabs2" class="tab-pane">
            <div class="row">
                <div class="col-sm-8">
                    ...
                    * @since 1.0
                    */
                    require_once( cUsDF_DIR . 'views/form-placement.php');
                    ?>
                </div>
