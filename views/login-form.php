            ...
            <form class="form-horizontal" role="form" id="login-form" action="admin.php?page=cUs_malchimp_plugin">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="submit" class="btn btn-info cUsDF_LoginUser" title="Welcome back ContactUs.com users" data-placement="bottom">Login</button> &nbsp; | &nbsp;
                ...
                <input type="hidden" name="action" value="cUsDF_loginAlreadyUser">
            </form>
        </div>
    </div>
    <div class="row">
