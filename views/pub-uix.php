    ...
    <div class="col-sm-12">
        <div id="cUsDF_tabs">
            <ul class="cu_border-bottom">
                <li><a href="#tabs-1" class="cu_bluebox dashboard-color">Donation Form Plugin</a></li>
            </ul>
            <div id="tabs-1">
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        * @since 1.0
                        */
                        require_once( cUsDF_DIR . 'views/login-form.php');
                        ?>
                        ...
                        * @since 1.0
                        */
                        require_once( cUsDF_DIR . 'views/signup-form.php');
                        ?>
                        ...
                        <div class="contaus_features">
                            ...
                            <div class="road_features">
                                ...
                                <div class="_row r6">
                                    ...
                                    <div class="_col"></div>
                                    <div class="_col"></div>
                                    <div class="_col"><a id="cUsDF_signup_cloud" class="feature cloud setLabels" href="#signupform"></a></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4 sidebar">
                         ...
                         * @since 1.0
                         */
                        include( cUsDF_DIR . 'views/sidebar-pub.php');
                        ?>
                    </div>
                </div>
            </div>
