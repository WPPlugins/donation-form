...
<table class="table table-hover">
    ...
    <tbody>
        ...
        <tr>
            <?php
            //$homeSettings    = get_option('cUsDF_settings_HOME');
            $homeSettings    = get_option('cUsDF_HOME_settings');
//            if(!empty($homeSettings)){
//                update_option('cUsDF_settings_HOME', $homeSettings);
//                $homeSettings    = get_option('cUsDF_settings_HOME');
//                //delete_option('cUsDF_HOME_settings');
//            }
            ...
            <form name="page-form-home" id="page-form-home">
                ...
                <input type="hidden" name="action" value="cUsDF_setPageSettingsHome">
            </form>
        </tr>
        <!-- FORM TR END -->
    ...
    <?php
        ...
        if (is_array($mypages)) {
            foreach ($mypages as $page) {
                $pageSettings = get_post_meta($page->ID, 'cUsDF_FormByPage_settings', true);
                //cUsDF_FormByPage_settings
                ?>
                ...
                <tr class="form_placement_item">
                    ...
                    <form name="page-form-<?php echo $page->ID; ?>" id="page-form-<?php echo $page->ID; ?>">
                        ...
                        <td>
                            ...
                            <select class="form-control form_key_byPage" name="form-key" data-pageid="<?php echo $page->ID; ?>">
                                ...
                                if ($cUsDF_API_getFormKeys) {
                                    ...
                                    update_option('cUsDF_settings_form_thumbs', $aryFormThumbs );//UPDATE FORM SETTINGS
                                }
                                ?>
                            </select>
                            <script>
                        ...
                        <td><strong>Inline</strong><br><input type="checkbox" class="custom-page-checkbox" name="checkbox_inline_page_<?php echo $page->ID; ?>" data-pageid="<?php echo $page->ID; ?>" data-version="inline" <?php echo @( ( !empty($pageSettings) && $pageSettings['form_status_inline'] ) || ( $pageSettings['cus_donation_version'] == 'inline' ) ) ? 'checked': ''; ?> ></td>
                        <td><strong>Tab</strong><br><input type="checkbox" class="custom-page-checkbox" name="checkbox_tab_page_<?php echo $page->ID; ?>" data-pageid="<?php echo $page->ID; ?>" data-version="tab" <?php echo @( ( !empty($pageSettings) && $pageSettings['form_status'] ) || ( $pageSettings['cus_donation_version'] == 'tab' && $pageSettings['tab_user'] ) ) ? 'checked': ''; ?> ></td>
                        <td>
                        ...
                        <input type="hidden" name="action" value="cUsDF_setPageSettings">
...
<script>
    ...
    cUsDF_myjq(document).ready(function($) {
        ...
        $('.form_key_byPage').change(function(){
            ...
            var oFormData = 'action=cUsDF_setFormKeyByPage';
