...
cUsDF_myjq(document).ready(function($) {
    ...
    $('.introjs-skipbutton').on('click',function(){
        ...
        bootbox.confirm("User guide will appear again using the help button above.", function(result) {
            if(result){
                $.ajax({ type: "POST", url: ajax_object.ajax_url, data: {action:'cUsDF_disable_introjs'},
    ...
    intro.setOptions({
        steps: [
            ...
            },
            {
                ...
                intro: "<div class='intro_box_ai intro'><h1>Forms Panel</h1><ul><li>Shows a list of your Donation Forms in your ContactUs.com account.</li><li>Shows customization options for each form as well as form previews. </li><li>Allows you to place the callout tab of a specific form, across your entire site. (You can do this with 1 or more forms).  </li><li>Provides one-click navigation to configure your donation forms.</li></ul></div>"
            },
            {
                //3
                element: '#cu_nav_page',
